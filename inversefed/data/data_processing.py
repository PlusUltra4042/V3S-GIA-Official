...
def construct_dataloaders(dataset, defs, data_path='~/data', shuffle=True, normalize=True):
    ...
    if dataset == 'CIFAR10':
        ...
        trainset, validset = _build_cifar100("home/GLA_File/Meta_Learning/model/data", defs.augmentations, normalize)
        loss_fn = Classification()
    elif dataset == 'MNIST':
...
def _build_cifar100(data_path, augmentations=True, normalize=True):
    ...
    # Load data
    trainset = torchvision.datasets.CIFAR100(root="home/GLA_File/Meta_Learning/model/data/cifar-100-python/train", train=True, download=True, transform=transforms.ToTensor())
    validset = torchvision.datasets.CIFAR100(root="home/GLA_File/Meta_Learning/model/data/cifar-100-python/test", train=False, download=True, transform=transforms.ToTensor())
